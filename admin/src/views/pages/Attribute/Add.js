...
import { addAttributeAction } from "../../../features/attributeSlice";
    ...
    return (
        <div className="addLeagueBlock">
            <div className="title_breadcrumb_section">
                <div className="title_page">Add New Attribute</div>
                    ...
                    <div className="formAddBlock">
                        <Formik
                            ...
                            onSubmit={async (values) => {
                                ...
                                setLoader(true);
                                await dispatch(addAttributeAction(payload, (response) => {
