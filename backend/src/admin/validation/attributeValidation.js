...
module.exports = {
    createAttributeValidation: async (req, res, next) => {
    ...
    updateAttributeValidation: async (req, res, next) => {
        // Define the validation schema using Joi
        const schema = Joi.object({
            id: Joi.string()
    ...
    listAttributeValidation: async (req, res, next) => {
        // Define the validation schema using Joi
        const schema = Joi.object({
            page: Joi.number()
    ...
    statusChangeAttributeValidation: async (req, res, next) => {
        // Define the validation schema using Joi
        const schema = Joi.object({
            id: Joi.string()
                .length(24) // Ensures the id is exactly 24 characters long (for MongoDB ObjectId)
